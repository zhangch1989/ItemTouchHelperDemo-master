package com.zch.tooldemos.demoviewpager;
...
public class StandardViewPagerActivity extends Activity {
...
//            mViewPager.setClipChildren(false);
        ...
        {
            mViewPager.setPageTransformer(true, new ScaleInTransformer(0.5f, new AlphaPageTransformer()));
